...
export const SERVER_NAME = "bugwatch-mcp";
export const SERVER_VERSION = "0.2.0";

/**
 * Build a fully-wired Bugwatch MCP server around a client. Both the stdio entry
 * point (index.ts) and the hosted HTTP entry point (http.ts) use this so the
 * resource/tool/prompt surface stays identical across transports.
 */
export function createBugwatchServer(client: BugwatchClient): Server {
