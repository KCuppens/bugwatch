...
CREATE INDEX idx_transactions_name ON transactions(transaction_name);
...
CREATE INDEX idx_transactions_duration ON transactions(duration_ms);
...
CREATE INDEX idx_spans_op ON spans(op);
