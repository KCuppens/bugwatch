        ...
        <PaywallProvider>
          <CommandPaletteProvider>
            <div className="min-h-screen bg-background bg-gradient-mesh">
              <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:top-2 focus:left-2 focus:px-4 focus:py-2 focus:bg-accent focus:text-accent-foreground focus:rounded-lg">
                Skip to content
              </a>
