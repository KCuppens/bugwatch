        ...
        <div className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-green-100 dark:bg-green-900/50 rounded-full">
              <Percent className="h-4 w-4 text-green-600 dark:text-green-400" aria-hidden="true" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="font-medium text-green-800 dark:text-green-200">
                  <span className="sr-only">Coupon applied: </span>
              ...
              <p className="text-xs text-green-600 dark:text-green-400">{formatDuration(appliedCoupon)}</p>
            </div>
          </div>
          <Button
            variant="ghost"
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex gap-2">
        ...
        <Button onClick={handleValidate} disabled={!code.trim() || disabled || validating} variant="secondary">
          {validating ? (
